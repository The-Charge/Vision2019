...
# 
# @videomapping YUYV 640 480 30 YUYV 640 480 30 TheCharge VisionGripPipeline
# @email 
...
##################################################################################################
        ...
        # Write a title:
        cv2.putText(outimg, "JeVois VisionGripPipeline", (3, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255,255))
